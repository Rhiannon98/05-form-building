...
// function called in html file, to be more efficient, and allow auto reload.
articleView.initNewArticlePage = () => {
  // DONE SON: Ensure the main .tab-content area is revealed. We might add more tabs later or otherwise edit the tab navigation.
  $('.tab-content').show();
